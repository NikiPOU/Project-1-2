...
class mainPhysics{
    ...
    public static void main(String[] args) {
        ...
        CelestialBody3 mercury = new CelestialBody3(mervel, merpos, 3.302E+23);
        ...
        CelestialBody3[] bodies = new CelestialBody3[]{sun, earth, venus, mars, uranus, neptune, mercury, moon, titan, saturn, jupiter};
