...
class mainPhysics{
    ...
    public static void main(String[] args) {
        ...
        double[] i = {5, 6, 1};
        double[] o = {4, 1, 2};
        CelestialBody3 sun = new CelestialBody3(v, v, 2);
        CelestialBody3 earth = new CelestialBody3(t, y, 3);
        CelestialBody3 venus = new CelestialBody3(x, i, 1);
        CelestialBody3 mars = new CelestialBody3(i, o, 4);
        Physics_Engine physics = new Physics_Engine();

        CelestialBody3[] bodies = new CelestialBody3[4];
        bodies[0] = sun;
        bodies[1] = earth;
        bodies[2] = venus;
        bodies[3] = mars;
