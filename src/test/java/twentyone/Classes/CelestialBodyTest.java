...
public class CelestialBodyTest {
    public CelestialBody earth = new CelestialBody(new Vector3d(5, -29,  0.001),
        new Vector3d( -148186906.893642,  -27823158.5715694,  33746.8987977113), 5.97219E+24);
    ...
    public void testToString() {
        ...
        assertTrue(res.equals("[Celestial body: [position: -1.48186906893642E8, -2.78231585715694E7, 33746.8987977113]," + 
